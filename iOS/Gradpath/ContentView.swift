...
struct ContentView: View {
    ...
    @State private var editingItem: RequirementItem?
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Requirement") {
                    TextField("Requirement", text: $title)
                ...
                Section("Term") {
                    DatePicker("Term", selection: $date, displayedComponents: .date)
                }
                Section("Completed") {
            ...
            .navigationTitle(mode == .add ? "Add Requirement" : "Edit Requirement")
            .toolbar {
